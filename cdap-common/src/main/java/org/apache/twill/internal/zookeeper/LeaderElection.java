...
public final class LeaderElection extends AbstractService {
  ...
  public ListenableFuture<com.google.common.util.concurrent.Service.State> start() {
    SettableFuture<com.google.common.util.concurrent.Service.State> future = SettableFuture.create();
  ...
  public ListenableFuture<com.google.common.util.concurrent.Service.State> stop() {
    SettableFuture<com.google.common.util.concurrent.Service.State> future = SettableFuture.create();
    addListener(new Listener() {
      @Override
