...
/**
 * A {@link ZKClient} that forwards all methods to another {@link ZKClient}.
 */
public abstract class ForwardingZKClient extends AbstractZKClient {
  ...
  @Override
  public OperationFuture<Stat> setData(String path, byte[] data, int version) {
    return delegate.setData(path, data, version);
  }

  @Override
  public OperationFuture<String> delete(String path, int version) {
    return delegate.delete(path, version);
  }
