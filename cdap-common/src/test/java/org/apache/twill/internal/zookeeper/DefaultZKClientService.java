...
public final class DefaultZKClientService extends AbstractZKClient implements ZKClientService {
  ...
  private OperationFuture<String> doCreate(final String path,
    ...
    addCallback(createFuture, new FutureCallback<String>() {
      @Override
      ...
      public void onFailure(Throwable t) {
        ...
        addCallback(doCreate(parentPath, null, CreateMode.PERSISTENT,
  ...
  private <V> void addCallback(ListenableFuture<V> future, FutureCallback<? super V> callback) {
