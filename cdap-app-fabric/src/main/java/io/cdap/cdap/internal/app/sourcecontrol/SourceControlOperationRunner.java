...
/**
 * This interface is used for defining the execution of SourceControlOperator push/pull/list either for distributed mode
...
public interface SourceControlOperationRunner {
   ...
   */
  ListenableFuture<PushApplicationsResponse> push();
